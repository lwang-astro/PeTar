...
class SingleEscaper(Particle):
    ...
    def __init__ (self, _dat=None, _offset=int(0), _append=False, **kwargs):
        ...
        keyword arguments:
            ...
            interrupt_mode: string (none)
                PeTar interrupt mode: base, bse, mobse, sevn, none
    ...
    def findEscaper(self, time, single, rcut, pot_cut=0.0):
        """ Find escaper from a snapshot
        Functions, calcR2, calcEkin and calcEtot, are used first for input single data set,
        then distance r<rcut and energy etot > mass*pot_cut will be selected as escapers.
        ...
        rcut2 = rcut*rcut
        ssel = ((single.r2>rcut2) & (single.etot-single.mass*pot_cut>0.0))
...
class BinaryEscaper(Binary):
    ...
    def findEscaper(self, time, binary, rcut, pot_cut=0.0):
        ...
        then c.m. distance r<rcut and c.m. energy etot > mass*pot_cut will be selected as escapers.
        ...
        rcut2 = rcut*rcut
        bsel = (binary.r2>rcut2) & (binary.etot-binary.mass*pot_cut>0.0)
