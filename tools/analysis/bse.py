...
class GWKick(DictNpArrayMix):
    ...
    Keys: (class members)
        ...
        m1 (1D): particle mass of component 1 before merger (Msun)
        m2 (1D): particle mass of component 2 before merger (Msun)
        mf (1D): final mass after merger (Msun)
        r1 (1D): particle radius of component 1 before merger (Rsun)
        r2 (1D): particle radius of component 2 before merger (Rsun)
        rf (1D): particle radius of merger (Rsun)
