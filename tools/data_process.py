...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print("     --esc-snapshot-format: set escaper snapshot data format for reading: binary, ascii, npy (follow -s)")
        print("                            These files (*.esc_single, *.esc_binary) are generated by previous petar.data.process.")
        print("                            This option is used when --append mode is switched on.")
