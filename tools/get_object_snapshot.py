...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print("Usage: petar.get.object.snap [options] (type|id|id_filename|bid|bid_filename|mass_range) [typeb|mass_rangeb] data_filename")
        ...
        print("                    For example, '0.5-1' indicates mass between 0.5 and 1.0.")
