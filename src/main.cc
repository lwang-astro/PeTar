...
int main(int argc, char *argv[]){
    ...
    IOParams<PS::F64> e_err_arc    (input_par_store, 1e-8,"Maximum energy error allown for ARC integrator");
    ...
    IOParams<PS::F64> sd_factor    (input_par_store, 1e-5, "Slowdown perturbation criterion");
