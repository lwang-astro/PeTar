...
*
* Next is for chossing the EMP track model
* trackmode: two choices
*     1: ffbonn
*     2: ffgeneva
*
...
* output file
*
      OPEN(10,file='evolve.dat',status='unknown')
      WRITE(10,*) ' Tev(Myr)              type              ',
     &     'Mo                  Mt                log10(L) ',
     &     '           log10(R)           log10(Teff)',
     &     '            Mc                  Menv               ' ,
     &     ' epoch                spin' 
...
**      text1 = ' Tev(Myr)              type              ',
**     &     'Mo                  Mt                log10(L) '
**      text2 = '           log10(R)           log10(Teff)',
**     &     '  Mc                  Menv               ' 
**      text3 = ' epoch                spin' 
**      WRITE(23,'(a,a,a)')text1,text2,text3
*      WRITE(23,*) ' Tev(Myr)              type              ',
*     &     'Mo                  Mt                log10(L) ',
*     &     '           log10(R)           log10(Teff)',
*     &     '            Mc                  Menv               ' ,
*     &     ' epoch                spin' 
