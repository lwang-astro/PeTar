...
*
 ...
 33         FORMAT(1p,E20.12,0p,I20,1p,11E20.12,0p)
            write(10,33) tphys,kw,mass,mt,
     &           log10(lum),log10(r),log10(teff),
     &           mc,rc,menv,renv,epoch,ospin
            tprint = tprint + dtp
         endif
