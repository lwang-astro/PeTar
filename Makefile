...
HARD_DEBFLAGS+= -D AR_DEBUG -D AR_WARN -D HARD_DEBUG -D HARD_CHECK_ENERGY -D HARD_DEBUG_PRINT -D ADJUST_GROUP_DEBUG -D HERMITE_DEBUG
HARD_MT_FLAGS += -D AR_SYM -D SPLIT_MASS
