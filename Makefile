...
MT_FLAGS += -D AR_TTL
MT_FLAGS += -D AR_TTL_SLOWDOWN_INNER
...
DEBFLAGS += -D FAKE_PARTICLE_DEBUG
...
HARD_MT_FLAGS += -D AR_TTL -D AR_TTL_SLOWDOWN_INNER -D SLOWDOWN_TIMESCALE -D STABLE_CHECK_DEBUG_PRINT -D FAKE_PARTICLE_DEBUG
