...
Since the first line in the snapshot file is the header, `skiprows=1` will jump this line when read data.
To obtain the header information, _petar.PeTarDataHeader_ class can be used:
```
...
This filter can also be used to the members:
```
